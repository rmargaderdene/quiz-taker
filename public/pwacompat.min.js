...
(function() {
  ...
  function q() {
    var a = document.head.querySelector('link[rel="pwa-setup"]'),
      b = a ? a.href : '';
  ...
  function y(a) {
    for (var b = {}, e = 0; e < a.length; b = { c: b.c }, ++e) {
      b.c = a[e];
      try {
        return (
          new URL('', b.c),
  ...
  function k(a, b) {
    b && (!0 === b && (b = 'yes'), E('meta', { name: a, content: b }));
  }
  function w(a) {
  ...
  function H(a, b) {
    function e(f, c, l, h) {
      ...
      h &&
        ...
        48 <= c &&
          48 <= d &&
          (m.drawImage(h, c / -2, d / -2, c, d), m.translate(0, d / 2 + 32)));
      ...
      if (d < 0.8 * f) m.fillText(h, d / -2, 0);
      else
        for (h = h.split(/\s+/g), d = 1; d <= h.length; ++d) {
          c = h.slice(0, d).join(' ');
          var I = m.measureText(c).width;
          if (d === h.length || I > 0.6 * f)
            m.fillText(c, I / -2, 0),
              m.translate(0, 24 * 1.2),
              h.splice(0, d),
              (d = 0);
        }
      return function() {
    ...
    var C = (0 < p.length ? p : r)
      .map(function(f) {
        var c = { rel: 'icon', href: b(f.src), sizes: f.sizes };
        E('link', c);
        if (D && !(120 > w(f)))
          return (c.rel = 'apple-touch-icon'), E('link', c);
      })
      .filter(Boolean);
    ...
    X &&
      ...
      (r = r[0]) && k('msapplication-TileImage', b(r.src)),
    ...
    if (D || Z) {
      ...
      if (D)
        k(
          ...
          b ? 'black-translucent' : e ? 'black' : 'default'
        );
      else {
        a: {
          try {
        ...
        if ((b = g))
          (b.foregroundColor = N(e ? 'black' : 'white')),
  ...
  function K(a, b, e) {
    ...
    var g = F(a);
    g.drawImage(a, 0, 0);
    if (e || 255 !== g.getImageData(0, 0, 1, 1).data[3])
      return (
